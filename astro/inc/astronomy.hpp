...
TODO:
- would telescope be better off as a struct or class?
- func splot: is calculate FOV for example, better in astronomy or telescope?
- private vs public divide 
- is astronomy or processing a better name? astronomy isn't exactly accurate, but processing is too generic 
- should store in RAM be a func on the sd card side or here? leaning towards sd card
